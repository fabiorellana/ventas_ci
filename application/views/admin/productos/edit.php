                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/productos/update" method="post">
                            ...
                            <div class="form-group <?php echo !empty(form_error("nombre")) ? 'has-error':''; ?>">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo !empty(form_error("nombre")) ? set_value("codigo"):$producto->nombre;?>">
                            ...
                            <div class="form-group <?php echo !empty(form_error("precio")) ? 'has-error':''; ?>">
                                ...
                                <input type="text" class="form-control" id="precio" name="precio" value="<?php echo !empty(form_error("precio")) ? set_value("codigo"):$producto->precio;?>">
                                <?php echo form_error("precio","<span class='help-block'>","</span>"); ?>
                            </div>
                            <div class="form-group <?php echo !empty(form_error("stock")) ? 'has-error':''; ?>">
                                <label for="stock">Stock:</label>
                                <input type="text" class="form-control" id="stock" name="stock" value="<?php echo !empty(form_error("stock")) ? set_value("codigo"):$producto->stock;?>">
